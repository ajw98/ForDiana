...
#ifndef _MODEL_ENERGY_FHG_H
#define _MODEL_ENERGY_FHG_H
...
class Model_Energy_FHG : public Model_Energy_Base
{

  public:
    Model_Energy_FHG( Operators_Base & OpObj, int ncomp, int nicomp );
    ~Model_Energy_FHG();
