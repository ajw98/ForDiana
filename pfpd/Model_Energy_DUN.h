...
#ifndef _MODEL_ENERGY_DUN_H
#define _MODEL_ENERGY_DUN_H
...
class Model_Energy_DUN : public Model_Energy_Base
{

  public:
    Model_Energy_DUN( Operators_Base & OpObj, int ncomp, int nicomp );
    ~Model_Energy_DUN();
