...
#ifndef _TIMEINT_MODELH_GRIDDEF_H
#define _TIMEINT_MODELH_GRIDDEF_H
...
class TimeInt_ModelH_GridDef : public TimeInt_Base
{

  public:

    // --- constructor/destructor ---
    TimeInt_ModelH_GridDef( int Ncomp, int NIcomp, Grid* CurrGrid );
    ~TimeInt_ModelH_GridDef();
  ...
  private:
    ...
    Vec2dReal _G;
    RealType _gammadot;
    Vec2dReal _CellTensor;
    Vec2dReal _InitBoxTensor;
...
#endif // _TIMEINT_MODELH_GRIDDEF_H
