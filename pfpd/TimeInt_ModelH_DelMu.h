...
#ifndef _TIMEINT_MODELH_DELMU_H
#define _TIMEINT_MODELH_DELMU_H
...
class TimeInt_ModelH_DelMu : public TimeInt_Base
{

  public:

    // --- constructor/destructor ---
    TimeInt_ModelH_DelMu( int Ncomp, int NIcomp, Grid* CurrGrid );
    ~TimeInt_ModelH_DelMu();
  ...
  private:
    ...
    void step_phi( SmartFieldVec &phi, SmartFieldVec const &vel, SmartFieldMat const &del_mu,
                   SmartFieldVec const &mu_lin, SmartFieldOpMat const &mu_lin_np1,
                   RealType dt, RealType t );
    void step_vel( SmartFieldVec const &phi, SmartFieldVec &vel, SmartFieldMat const &del_mu,
