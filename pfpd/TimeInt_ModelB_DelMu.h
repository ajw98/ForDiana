...
#ifndef _TIMEINT_MODELB_DELMU_H
#define _TIMEINT_MODELB_DELMU_H
...
class TimeInt_ModelB_DelMu : public TimeInt_Base
{

  public:

    // --- constructor/destructor ---
    TimeInt_ModelB_DelMu( int Ncomp, int NIcomp, Grid* CurrGrid );
    ~TimeInt_ModelB_DelMu();
  ...
  private:
    ...
    void step_phi( SmartFieldVec &phi, SmartFieldMat const &del_mu,
